...
export default class CryptUtil {
    ...
    private cryptPrivSecretFile: string;
    private cryptJwtSecretFile: string;

    private jwtSecret?: string;
    private privateSecret?: string;

    constructor() {
        this.directory = process.cwd() + "/config/crypt/";
        this.cryptPrivSecretFile = this.directory + "private.secret";
        this.cryptJwtSecretFile = this.directory + "jwt.secret";
